                        ...
                        <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <x-jet-input id="url" type="url" name="url" placeholder="https://github.com/vlasscontreras/laravel-pest" class="mt-1 block w-full" value="{{ old('url', $repository->url) }}" />
                                    <x-jet-input-error for="url" class="mt-2" />
                                </div>
                                <div class="col-span-6 sm:col-span-4">
                                    <x-jet-label for="description" value="{{ __('Description') }}" />
                                    <x-jet-input id="description" type="text" name="description" placeholder="{{ __('A Laravel application that uses Pest as testing library.') }}" value="{{ old('description', $repository->description) }}" class="mt-1 block w-full" />
